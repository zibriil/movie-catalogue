...
describe('Searching movies', () => {
  ...
  describe('When query is not empty', () => {
    ...
    it('should show the found movies found by Favorite Movies', () => {
    ...
    it('should show the title of the found movies', () => {
      ...
      expect(movieTitles.item(0).textContent).toEqual('Film Satu');
      expect(movieTitles.item(1).textContent).toEqual('Film Dua');
    });
