...
describe('Liking A Movie', () => {
  ...
  it('Should show the like button movie when the movie has not been liked before', async () => {
  ...
  it('Should hide the unlike button when the movie has not been liked before', async () => {
    await TestFactories.createLikeButtonPresenterWithMovie({ id: 1 });
  ...
  it('Should not add a movie again when it has not ID', async () => {
